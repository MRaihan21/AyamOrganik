...
public class TampilDataRestock extends JFrame implements ActionListener{

    public static void main(String[] args) {
        
        new TampilDataRestock();
        
    }

    JPanel lefPanel, upRightPanel;
    JLabel penjualan, restock, prof;
    JButton loBtn, idBtn, tdBtn, stBtn, upLeftPanel;
    
    public TampilDataRestock() {
