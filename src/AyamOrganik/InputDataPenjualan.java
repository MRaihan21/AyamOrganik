...
public class InputDataPenjualan extends JFrame implements ActionListener {
    ...
    JLabel penjualan, prof, tanggalPenjualan, lblNp, LblPa, lblTa, lblTh, lblTxtTp, lblTxtNp;
    JLabel sd, st, se, sl, fp, fd;
    JButton loBtn, idBtn, tdBtn, stBtn, inputBtn, upRightPanel;
    ...
    public InputDataPenjualan() {
        ...
        //
        tanggalPenjualan = new JLabel("Tanggal Penjualan");
...
//        lblTh = new JLabel("Total Harga");
//        lblTh.setBounds(293, 375, 90, 25);
//        add(lblTh);
//
//        lblTa = new JLabel("Total Ayam");
//        lblTa.setBounds(186, 375, 90, 25);
//        add(lblTa);
